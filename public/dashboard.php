  ...
  <div class="flex min-h-screen">
    ...
    <div class="flex-1 p-6 overflow-y-auto">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <!-- Solar Panel 2 Card -->
        <div id="solar2Widget" class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 transition-all duration-300 hover:shadow-lg">
          <div class="flex justify-between items-center mb-4">
            <h2 class="text-lg font-semibold m-0">Zonnepaneel 2 (Bar Chart)</h2>
            <div class="flex gap-2">
              <button class="w-8 h-8 rounded-full flex items-center justify-center cursor-pointer bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 border-none">
                <i class="fas fa-expand"></i>
              </button>
          ...
          <div class="relative" style="height: 300px">
            <canvas id="solarChart2" class="w-full h-full"></canvas>
          </div>
        </div>
